...
public class Customer {
    ...
    public Customer(String name, String contact, String address, String city, String postCode, String country) {
        this.name = name;
        this.contact = contact;
        this.address = address;
        this.city = city;
    ...
    public String toString() {
        return String.format("ID: %d, Name: %s, Contact: %s, Address: %s, City: %s, PostalCode: %s, Country: %s",
                getId(), getName(), getContact(), getAddress(),
                getCity(), getPostCode(), getCountry());
    }
}
